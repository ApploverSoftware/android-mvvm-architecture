 ...
 */
class ExampleCityAdapter(private val cities: ArrayList<ExampleCityModel>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            R.layout.example_item_network_state -> ExampleNetworkStateViewHolder(view)
