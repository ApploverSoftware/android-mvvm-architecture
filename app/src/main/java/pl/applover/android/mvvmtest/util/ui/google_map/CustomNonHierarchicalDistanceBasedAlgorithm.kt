 ...
 */
class CustomNonHierarchicalDistanceBasedAlgorithm<T : ClusterItem> : Algorithm<T> {

    /**
     * Any modifications should be synchronized on mQuadTree.
     */
    private val mItems = ArrayList<QuadItem<T>>()
    ...
    override fun getClusters(zoom: Double): Set<Cluster<T>> {
        ...
        val zoomSpecificSpan = MAX_DISTANCE_AT_ZOOM.toDouble() / Math.pow(2.0, discreteZoom.toDouble()) / 256.0
    ...
    private class QuadItem<T : ClusterItem> internal constructor(internal val mClusterItem: T) : PointQuadTree.Item, Cluster<T> {
    ...
    companion object {
        val MAX_DISTANCE_AT_ZOOM = 100 // essentially 100 dp.
